...
public enum AnimatedStars {
  ...
  private static func bubbles(viewController: UIViewController) {
    animate(viewController: viewController, numberOfImages: 50, imageSizeMinimum: 4, imageSizeMaximum: 12, riseTimeMin: 0.8, riseTimeMax: 3.0,  image: UIImage(systemName: "circle.fill"), imageTintColor: .white)
  }
